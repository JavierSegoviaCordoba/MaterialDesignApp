package com.example.javier.MaterialDesignApp.Utilitis.SwipeRefresh;
...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mDirection = SwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.SwipeRefreshLayout_direction, 0));
        a2.recycle();
